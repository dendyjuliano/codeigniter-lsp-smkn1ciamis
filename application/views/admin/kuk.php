...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <div class="buton ml-auto">
            <a href="#" data-toggle="modal" data-target="#excel" class="d-none d-sm-inline-block btn btn-sm btn-success shadow-sm"><i class="fas fa-file-excel  text-white-50"></i> Import Excel</a>
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td><?= $row['judul_kuk'] ?></td>
                                <td>
                                    <a class="btn btn-danger tombol-hapus" href="<?= base_url('admin/delete_kuk/') ?><?= $row['id'] ?>"><i class="fas fa-trash"></i></a>
                                    <a class="btn btn-success" href="<?= base_url('admin/edit_kuk/') ?><?= $row['id'] ?>"><i class="fas fa-edit"></i></a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
...
<div class="modal fade" id="tambah" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="<?= base_url('admin/kuk') ?>" method="post">
                <div class="modal-body">
                    ...
                    <div class="input-group mb-3 row">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control" name="id_elemen" value="<?= set_value('id_elemen') ?>">
                    ...
                    <div class="input-group mb-3 row">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control" name="id_kuk" value="<?= set_value('id_kuk') ?>">
                            <?= form_error('id_kuk') ?>
                        </div>
                    </div>
                    <div class="input-group mb-3 row">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control" name="judul_kuk" value="<?= set_value('judul_kuk') ?>">
...
<div class="modal fade" id="excel" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="<?= base_url('admin/importFileKuk') ?>" method="post" enctype="multipart/form-data">
                <div class="modal-body">
