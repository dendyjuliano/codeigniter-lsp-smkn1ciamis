            ...
            <div class="table-responsive">
                <table class="table data" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        <?php
                        $no = 1;
                        foreach ($elemendata as $row) :
                        ?>
                            <tr>
                                <td><?= $no++ ?></td>
                                <td><?= $row['id_skema'] ?></td>
                                <td><?= $row['id_elemen'] ?></td>
                                <td><?= $row['judul_elemen'] ?></td>
                                <td>
                                    <a class="btn btn-danger tombol-hapus" href="<?= base_url('admin/delete_elemen/') ?><?= $row['id'] ?>"><i class="fas fa-trash"></i></a>
                                    <a class="btn btn-success" href="<?= base_url('admin/edit_elemen/') ?><?= $row['id'] ?>"><i class="fas fa-edit"></i></a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
...
<div class="modal fade" id="tambah" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="<?= base_url('admin/elemen') ?>" method="post">
                <div class="modal-body">
                    ...
                    <div class="input-group mb-3 row">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control" name="id_elemen">
                    ...
                    <div class="input-group mb-3 row">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control" name="judul_elemen">
...
<div class="modal fade" id="excel" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="<?= base_url('admin/importFileElemen') ?>" method="post" enctype="multipart/form-data">
                <div class="modal-body">
